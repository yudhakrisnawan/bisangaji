                            ...
                            <div class="table-responsive">
                                <div class="konten" align="center">
                                    <div class="doa">
                                        ...
                                        <p class ="latin">Nawaitul wudhuua lirof’il hadatsil asghori fardholillahi ta’ala<br>
                                        “Saya niat berwudhu untuk menghilangkan hadats kecil karena Allah Ta’ala.”</p>
                                    </div>
                                    <br>
                                    <hr>
                                    <br>
                                    <div class="doa">
                                        <h4>Doa Sesudah Berwudhu</h4> 
                                        <br>
                                        ...
                                        <p class ="latin">Asyhadu alla ilaaha illalloh wahdahulasyarikalahu waasyhadu anna Muhammadan ‘abduhu warosuuluh
                                        ...
                                        ya Allah, jadikanlah aku dari golongan orang-orang yang bertaubat dan dan jadikanlah aku orang-orang yang suci, dan jadikanlah aku dari golongan orang-orang sholeh.”</p>
                                    </div>
                                </div>
                                <br>
                                <br>
