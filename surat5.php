                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="kad">
                                    <h4 class="judul" align="center">At-Tin</h4>
                                    <p class ="arabic_center">بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ</p>                    
                                </div>
                                <br>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">وَالتِّينِ وَالزَّيْتُونِ ﴿<span class="arabic_number">١</span>﴾</p>
                                    <p class ="latin" align="right">Wat tiini waz zaituun</p>                        
                                    <p class ="latin">[1] Demi (buah) Tin dan (buah) Zaitun,</p>                   
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">وَطُورِ سِينِينَ ﴿<span class="arabic_number">٢</span>﴾</p> 
                                    <p class ="latin" align="right">Wa tuuri siniin</p>                       
                                    <p class ="latin">[2] dan demi bukit Sinai,</p>                     
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">وَهَٰذَا الْبَلَدِ الْأَمِينِ ﴿<span class="arabic_number">٣</span>﴾</p>
                                    <p class ="latin" align="right">Wa haazal balad-il amiin</p>                        
                                    <p class ="latin">[3] dan demi kota (Mekah) ini yang aman,</p>                  
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">لَقَدْ خَلَقْنَا الْإِنْسَانَ فِي أَحْسَنِ تَقْوِيمٍ ﴿<span class="arabic_number">٤</span>﴾</p>
                                    <p class ="latin" align="right">Laqad khalaqnal insaana fii ahsani taqwiim</p>                        
                                    <p class ="latin">[4] sesungguhnya Kami telah menciptakan manusia dalam bentuk yang sebaik-baiknya.</p>                   
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">ثُمَّ رَدَدْنَاهُ أَسْفَلَ سَافِلِينَ ﴿<span class="arabic_number">٥</span>﴾</p>
                                    <p class ="latin" align="right">Thumma ra dad naahu asfala saafiliin</p>                        
                                    <p class ="latin">[5] Kemudian Kami kembalikan dia ke tempat yang serendah-rendahnya (neraka),</p>                   
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">إِلَّا الَّذِينَ آمَنُوا وَعَمِلُوا الصَّالِحَاتِ فَلَهُمْ أَجْرٌ غَيْرُ مَمْنُونٍ ﴿<span class="arabic_number">٦</span>﴾</p> 
                                    <p class ="latin" align="right">Ill-lal laziina aamanuu wa 'amilus saalihaati; falahum ajrun ghairu mamnuun</p>                       
                                    <p class ="latin">[6] kecuali orang-orang yang beriman dan mengerjakan amal saleh; maka bagi mereka pahala yang tiada putus-putusnya.</p>                   
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">فَمَا يُكَذِّبُكَ بَعْدُ بِالدِّينِ ﴿<span class="arabic_number">٧</span>﴾</p>
                                    <p class ="latin" align="right">Fama yu kaz zibuka b'adu bid diin</p>                        
                                    <p class ="latin">[7] Maka apakah yang menyebabkan kamu mendustakan (hari) pembalasan sesudah (adanya keterangan-keterangan) itu?</p>                
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">أَلَيْسَ اللَّهُ بِأَحْكَمِ الْحَاكِمِينَ ﴿<span class="arabic_number">٨</span>﴾</p>
                                    <p class ="latin" align="right">Alai sal laahu bi-ahkamil haakimiin</p>                        
                                    <p class ="latin">[8] Bukankah Allah Hakim yang seadil-adilnya?</p>                    
                                </div>
                            </div>
                        </div>   
                    </div>
