                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="kad">
                                    <h4 class="judul" align="center">Al-Qari`ah</h4>
                                    <p class ="arabic_center">بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ</p>                    
                                </div>
                                <br>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">الْقَارِعَةُ ﴿<span class="arabic_number">١</span>﴾</p> 
                                    <p class ="latin" align="right">Al qoori'ah</p>                          
                                    <p class ="latin">[1] Hari Kiamat,</p>                   
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">مَا الْقَارِعَةُ ﴿<span class="arabic_number">٢</span>﴾</p>
                                    <p class ="latin" align="right">Mal qooriah</p>                        
                                    <p class ="latin">[2] apakah hari Kiamat itu?</p>                    
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">وَمَا أَدْرَاكَ مَا الْقَارِعَةُ ﴿<span class="arabic_number">٣</span>﴾</p>  
                                    <p class ="latin" align="right">Wa maa adraaka mal qoori'ah</p>                      
                                    <p class ="latin">[3] Tahukah kamu apakah hari Kiamat itu?</p>                    
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">يَوْمَ يَكُونُ النَّاسُ كَالْفَرَاشِ الْمَبْثُوثِ ﴿<span class="arabic_number">٤</span>﴾</p>
                                    <p class ="latin" align="right">Yauma ya kuunun naasu kal farashil mabthuuth</p>                        
                                    <p class ="latin">[4] Pada hari itu manusia adalah seperti anai-anai yang bertebaran,</p>                    
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">وَتَكُونُ الْجِبَالُ كَالْعِهْنِ الْمَنْفُوشِ ﴿<span class="arabic_number">٥</span>﴾</p>  
                                    <p class ="latin" align="right">Wa ta kuunul jibalu kal 'ihnil manfuush</p>                      
                                    <p class ="latin">[5] dan gunung-gunung adalah seperti bulu yang dihambur-hamburkan.</p>                    
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">فَأَمَّا مَنْ ثَقُلَتْ مَوَازِينُهُ ﴿<span class="arabic_number">٦</span>﴾</p> 
                                    <p class ="latin" align="right">Fa-amma man thaqulat mawa ziinuh</p>                       
                                    <p class ="latin">[6] Dan adapun orang-orang yang berat timbangan (kebaikan)nya,</p>                    
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">فَهُوَ فِي عِيشَةٍ رَاضِيَةٍ ﴿<span class="arabic_number">٧</span>﴾</p> 
                                    <p class ="latin" align="right">Fahuwa fii 'ishatir raadiyah</p>                       
                                    <p class ="latin">[7] maka dia berada dalam kehidupan yang memuaskan.</p>                   
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">وَأَمَّا مَنْ خَفَّتْ مَوَازِينُهُ ﴿<span class="arabic_number">٨</span>﴾</p> 
                                    <p class ="latin" align="right">Wa amma man khaffat mawa ziinuh</p>                       
                                    <p class ="latin">[8] Dan adapun orang-orang yang ringan timbangan (kebaikan)nya,</p>                    
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">فَأُمُّهُ هَاوِيَةٌ ﴿<span class="arabic_number">٩</span>﴾</p>  
                                    <p class ="latin" align="right">Fa-ummuhu haawiyah</p>                      
                                    <p class ="latin">[9] maka tempat kembalinya adalah neraka Hawiyah.</p>                   
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">وَمَا أَدْرَاكَ مَا هِيَهْ ﴿<span class="arabic_number">١٠</span>﴾</p>
                                    <p class ="latin" align="right">Wa maa adraaka maa hiyah</p>                        
                                    <p class ="latin">[10] Tahukah kamu apakah neraka Hawiyah itu?</p>                   
                                </div>
                                <hr>
                                <div class="kad kad--padding kad--path">
                                    <p class ="arabic">نَارٌ حَامِيَةٌ ﴿<span class="arabic_number">١١</span>﴾</p>
                                    <p class ="latin" align="right">Naarun hamiyah</p>                        
                                    <p class ="latin">[11] (Yaitu) api yang sangat panas.</p>                    
                                </div>
                            </div>
                        </div>   
                    </div>
