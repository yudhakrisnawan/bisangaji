                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="konten" align="center">
                                    <div class="doa">
                                        <h4>Doa Selamat Dunia Akhirat</h4> 
                                        <br>
                                        <p class ="arabic_center">رَبَّنَا أَتِنَا فِي الدُّنْيَا حَسَنَةً وفِي الْأَخِرَةِ حَسَنَةً وَقِنَا عَذَابَ النَّارِ</p>                      
                                        <p class ="latin">Robbanaa atinaa fiddunyaa hasanah, wa filakhiroti hasanah wa qinaa adzaabannaar<br>
                                        “Ya Tuhan kami berilah kami kebaikan hidup di dunia dan kebaikan di akhirat, dan jagalah kami dari siksa api neraka.”</p>
                                    </div>
                                </div>                                   
                            <div>        
                        </div>   
